...
var settingsToSave = ["tags"],
    checkboxesToSave = ["forceRating", "ratingAsDefault", "setSafe", "setQuest", "setExplicit", "forceTags", "addTags", "sidecarTags", "title", "asFiles", "asFolder", "onlyErrors"],
    myTags = ((GetCookie("tags") || "+") + (GetCookie("my_tags") || "+") + (GetCookie("recent_tags") || "+")).replace(/%2520/gi, " ").replace(/%20|\++/gi, " ").trim().split(/\s+/),
    bat = [],
    header = {},
    stored = !1,
    move = "move",
